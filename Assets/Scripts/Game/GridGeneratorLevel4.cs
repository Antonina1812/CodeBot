...
// public class GridGeneratorLevel4 : MonoBehaviour
// {
...
public class GridGeneratorLevel4 : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _robotPrefab;
    [SerializeField] private GameObject _coinPrefab;
    [SerializeField] private GameObject _computerPrefab; // Добавлено: компьютер
    [SerializeField] private GameObject _diskPrefab;     // Добавлено: диск
    ...
    [SerializeField] private Vector2Int _computerPosition = new Vector2Int(3, 3); // Добавлено: позиция компьютера
    [SerializeField] private Vector2Int _diskPosition = new Vector2Int(2, 4);     // Добавлено: позиция диска
    ...
    void Start()
    {
        ...
        PlaceItems();
        PlaceCoins();
        PlaceComputerAndDisk(); // Добавлен вызов
        PlaceRobot();
    }
